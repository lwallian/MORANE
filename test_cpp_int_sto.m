...
init
rng('default');
% path = ['C:\Users\valentin.resseguier\Downloads\'];
% path = ['C:\Users\valentin.resseguier\Downloads\'];
path = 'F:\MATLAB\RedLUM\unitTestITHACALUM\temporal_integration\'
...
nb_realiz_vect = [2 1e1 1e2 1e3 1e4 1e6]
...
for nb_realiz = nb_realiz_vect
    ...
    for k = 1:nb_realiz
%         filename = [ path 'ITHACAoutput\Reduced_coeff_2_0.005_' ...
        filename = [ path 'ITHACAoutput\Reduced_coeff_2_' num2str(dt) '_' ...
