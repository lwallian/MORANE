...
bt_forecast_deter(1,:)=bt_tronc;
for l = 1:param.N_test
    bt_forecast_deter(l+1,:) = ...
        RK4( bt_forecast_deter(l,:), ...
        ILC_a_cst.deter.I,ILC_a_cst.deter.L,ILC_a_cst.deter.C, ...
        param.dt);
end

% Reconstruction in the stochastic case
bt_forecast_sto=nan([param.N_test+1 param.nb_modes]);
bt_forecast_sto(1,:)=bt_tronc;
for l = 1:param.N_test
    bt_forecast_sto(l+1,:) = RK4( bt_forecast_sto(l,:),...
