function var_bt = analyse_cv_full_sto_2(type_data,nb_modes,N_particules,n_simu)
...
% Plots to do
plot_deterministic=false; % deterministic POD-Galerkin
...
% threshold=0.0001; % for inc3D 3900
...
param.N_particules = N_particules;
