function main_full_sto_local(type_data,nb_modes,igrida,coef_correctif_estim,save_all_bi,decor_by_subsampl,a_time_dependant)
...
switch param.type_data
    case {'inc3D_Re300_40dt_blocks','inc3D_Re3900_blocks','inc3D_Re3900_blocks_truncated'}
