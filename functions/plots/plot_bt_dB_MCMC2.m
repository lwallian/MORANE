function plot_bt_dB_MCMC2(param,bt_forecast_sto_scalar,bt_forecast_sto_beta,...
...
bt_forecast_deter = sum( ...
    bsxfun(@times, 1./param.lambda', (bt_forecast_deter-bt_tot).^2 ) ...
    ,2)/nrj_tot+err_fix;
...
% struct_bt_MCMC.tot.mean = struct_bt_MCMC.tot.mean./sqrt(struct_bt_MCMC.tot.var);
% struct_bt_MCMC.tot.one_realiz = struct_bt_MCMC.tot.one_realiz./sqrt(struct_bt_MCMC.tot.var);
% struct_bt_MCMC.fv.mean = struct_bt_MCMC.fv.mean./sqrt(struct_bt_MCMC.tot.var);
struct_bt_MCMC.tot.mean = sum((struct_bt_MCMC.tot.mean-bt_tot).^2 ...
    ./ struct_bt_MCMC.tot.var ...
        ,2)/nrj_tot+err_fix;
struct_bt_MCMC.tot.one_realiz = sum((struct_bt_MCMC.tot.one_realiz-bt_tot).^2 ...
    ./ struct_bt_MCMC.tot.var ...
        ,2)/nrj_tot+err_fix;
struct_bt_MCMC.fv.mean = sum((struct_bt_MCMC.fv.mean-bt_tot).^2 ...
    ./ struct_bt_MCMC.tot.var ...
        ,2)/nrj_tot+err_fix;
bt_sans_coef1 = sum((bt_sans_coef1-bt_tot).^2 ...
    ./ struct_bt_MCMC.tot.var ...
        ,2)/nrj_tot+err_fix;
