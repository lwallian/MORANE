...
% Verify that the deterministic component is indeed an exponential decay
...
% Test that the integration is valid through the a comparison between
% euler maruyama and SSPRK3. The results should be identical
clear all, close all, clc;
...
% Same test as before but with the corrected geometric brownian motion in
% stratonovich so as to lead to the same results.
clear all, close all, clc;
...
%% Test relative error
% Same test but with varying number of realizations so as to verify the law
% of large numbers
clear all, close all, clc;
