function [result, pseudo_chol] = estimate_noise_non_orthogonal2(bt, eta, n, T, dt, n_particles, diagonal_G, lambda)
                ...
                for j = 1 : n
                    for k = 1 : T - 1
                        beta(p, i, q, j, l) = beta(p, i, q, j, l) + ...
                            bt_x(k, p, l) * d2bt_c(k, i, l) * deta_c(k, q, j, l) / G_pq(p,p,l);
